...
class enemy(OnBoard):
    ...
    def __init__(self, raw_image, position, _dir, speed=random.uniform(0,1), n = randint(20,40)):
        ...
        self.speed = speed #0.7#randint(1,1) #speed of enemy
        self.direction = 0 #direction of enemy
        self.c = 0 #counter to move enemy c number of times in each direction
        self.n = n #how many times to move enemy in each direction
