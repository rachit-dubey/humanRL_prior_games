...
class Board(object):
    ...
    def __init__(self, width, height, rewards, rng, _dir):
        ...
        self.IMAGES = {
            ...
            "ladder2": pygame.image.load(os.path.join(_dir, 'assets/ladder3.png')).convert_alpha(),
    ...
    def populateMap(self):
        ...
        self.map = np.loadtxt("map_similarity.txt", dtype='i', delimiter=',') #use numpy for python3
